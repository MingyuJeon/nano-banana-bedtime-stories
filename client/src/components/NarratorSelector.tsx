...
const NarratorSelector: React.FC<NarratorSelectorProps> = ({ onSelect }) => {
  ...
  const handlePreviewNarrator = async (
    e: React.MouseEvent,
    narratorId: string
  ) => {
          ...
          {narrators.map((narrator) => (
            <div
              ...
              style={{
                ...
                borderRadius: "12px",
                border: `3px solid ${
                  selectedNarrator?.id === narrator.id ? "#667eea" : "#e0e0e0"
                }`,
                cursor: "pointer",
                textAlign: "center",
                backgroundColor:
                  selectedNarrator?.id === narrator.id ? "#f0f4ff" : "white",
                transition: "all 0.3s ease",
                position: "relative",
              }}
            >
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    backgroundColor:
                      playingPreview === narrator.id ? "#667eea" : "#4CAF50",
                    color: "white",
                    cursor:
